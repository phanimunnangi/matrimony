...
<div class="wrapper-content animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					<form method="POST" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<input type="hidden" id="communityid" name="communityid" value="1">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="subcastename" type="text" name="subcastename" value="">
									<span id="error_subcastename" style="color:red"></span>
								</div>
							</div> 
    ...
    <script>
		function community_validate(){
			...
			if(subcastename==""){
				flag = false;
				$("#error_subcastename").html("Subcaste name is required.");
			}else{
				$("#error_subcastename").html("");
			}
			if(flag==false){
				return false;
			}else{
