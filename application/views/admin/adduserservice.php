                ...
                <div class="ibox-content">
					<form method="POST" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<select id="servicemasterid" name="servicemasterid" class="mdl-textfield__input form-control">
										...
										<?php 
											...
											<option value="<?php echo $item->servicemasterdisplayid; ?>"><?php echo ucfirst($item->servicemastername); ?></option>
										<?php } } ?>
									</select>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicename" type="text" name="servicename" value="" placeholder="Service Title">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceemailaddress" type="email" name="serviceemailaddress" value="" placeholder="Email address">
							...
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceprimarycontactnumber" type="number" name="serviceprimarycontactnumber" value="" placeholder="Contact Number">
									<span id="error_serviceprimarycontactnumber" style="color:red"></span>
								</div>
							</div> 
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicesecondarycontactnumber" type="number" name="servicesecondarycontactnumber" value="" placeholder="Second Contact Number">
							...
							<div class="col-xs-2">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicelandlinenumber_c" type="text" name="servicelandlinenumber_c" value="" placeholder="Code Eg: 040">
									<span id="error_servicelandlinenumber_c" style="color:red"></span>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicelandlinenumber" type="text" name="servicelandlinenumber" value="" placeholder="Land line number">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea class="mdl-textfield__input form-control" id="serviceaddress" name="serviceaddress" rows="4" cols="50" placeholder="Address"></textarea>
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicewebsite" type="text" name="servicewebsite" value="" placeholder="https://www.google.com">
							...
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceskil1" type="text" name="serviceskil1" value="" placeholder="Service1">
									<span id="error_serviceskil1" style="color:red"></span>
								</div>
							</div>
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceskil2" type="text" name="serviceskil2" value="" placeholder="Service2">
							...
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceskil3" type="text" name="serviceskil3" value="" placeholder="Service3">
									<span id="error_serviceskil3" style="color:red"></span>
								</div>
							</div>
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="serviceskil4" type="text" name="serviceskil4" value="" placeholder="Service4">
							...
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicefromdate" type="text" name="servicefromdate" value="" placeholder="Fromdate">
									<span id="error_servicefromdate" style="color:red"></span>
								</div>
							</div> 							
							<div class="col-xs-4">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="servicetodate" type="text" name="servicetodate" value="" placeholder="Todate">
							...
							<div class="col-xs-8"> 
								<input accept="image/*" type="file" name="servicewebimage" id="servicewebimage"  class="form-control" />
