...
<div class="wrapper-content animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					<form method="POST" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<input type="hidden" id="professionid" name="professionid" value="<?php echo $professiondetails->professiondisplayid; ?>">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="professionname" type="text" name="professionname" value="<?php echo $professiondetails->professionname; ?>">
									<span id="error_professionname" style="color:red"></span>
								</div>
							</div> 
    ...
    <script>
		function community_validate(){
			...
			if(professionname==""){
				flag = false;
				$("#error_professionname").html("Profession name is required.");
			}else{
				$("#error_professionname").html("");
			}
			if(flag==false){
				return false;
			}else{
