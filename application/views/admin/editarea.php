...
<div class="wrapper-content animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					<form method="POST" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<input type="hidden" id="areadisplayid" name="areadisplayid" value="<?php echo $areadetails->areadisplayid; ?>">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="areaname" type="text" name="areaname" value="<?php echo $areadetails->areaname; ?>">
									<span id="error_areaname" style="color:red"></span>
								</div>
							</div> 
    ...
    <script>
		function community_validate(){
			...
			if(areaname==""){
				flag = false;
				$("#error_areaname").html("Area name is required.");
			}else{
				$("#error_areaname").html("");
			}
			if(flag==false){
