...
<div class="wrapper-content animated fadeInRight">
                ...
                <div class="ibox-content">
					<form method="POST" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="bannertitle" type="text" name="bannertitle" value="">
							...
							<div class="col-xs-8"> 
								<input accept="image/*" type="file" name="bannerwebimage" id="bannerwebimage"  class="form-control" />
    ...
    <script>
		function community_validate(){
			...
			if(bannertitle==""){
				flag = false;
				$("#error_bannertitle").html("Banner title is required.");
			}else{
