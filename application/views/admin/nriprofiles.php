...
<script type="text/javascript">
	...
	function profileChange(){
		...
		if(profilesid=="male"){
			window.location= "<?php echo base_url()?>admin/common/nriprofiles?genderstatus=male";
		}else if(profilesid=="female"){
			window.location= "<?php echo base_url()?>admin/common/nriprofiles?genderstatus=female";
		}else{
