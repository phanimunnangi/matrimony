<!-- Page Banner Starts -->
        ...
        <!-- Nested Container Starts -->
            <div class="container px-md-0 text-white text-center d-none d-md-block" style="bottom:50%;">
                <h2 class="text-weight-semi-bold">Search Profiles</h2>
            </div>
        ...
        <!-- Nested Row Starts -->
			...
			<!-- Mainarea Starts -->
                <div class="col-lg-9 col-md-8 col-sm-12 pt-md-2 py-4 py-md-0">
					<?php if(isset($serachedprofiles) && !empty($serachedprofiles) && count($serachedprofiles)>0) { $i=1; foreach($serachedprofiles as $profile){ ?>
                <!-- List #1 Starts -->
