				...
				<!-- Personal Details Starts -->
					...
					<input type="text" name="profile_fullname" id="profile_fullname" class="form-control animation rounded-2" placeholder="Full Name" value="<?php if(isset($userinfo->profile_fullname) && $userinfo->profile_fullname!=""){ echo $userinfo->profile_fullname; } ?>">
						...
						<!-- Sub Caste Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_occupation" id="profile_occupation" class="custom-select">
						...
						<!-- Marital Status Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_marital_status" id="profile_marital_status" class="custom-select">
										<?php 					
						...
						<!-- NRI Ends -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_qualification" id="profile_qualification" class="custom-select">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_blood_group" id="profile_blood_group" class="custom-select">
						...
						<!-- Date of Birth Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<div class="d-flex justify-content-between">
										<select required name="profile_dob_date" id="profile_dob_date" class="custom-select alt-1">
											<?php for($d=1;$d<=31;$d++){ 
										...
										<select required name="profile_dob_month" id="profile_dob_month" class="custom-select alt-1 mx-2">
										<?php 
										...
										<select required name="profile_dob_year" id="profile_dob_year" class="custom-select alt-1">
				...
				<!-- Education & Communication Details Starts -->
					...
					<!-- Fields Starts -->
						...
						<!-- Residence Type Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_residence_type" id="profile_residence_type" class="custom-select">
										<?php 	
						...
						<!-- Email Address Starts -->
							...
							<div class="col-sm-6">
								<div class="form-group">
									<select onChange="getLocationArea();" name="profile_location_area" id="profile_location_area" class="custom-select">
				...
				<td class="" style="border:none">
				   <div class="">						
						...
						<!-- Qualification & Profession Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_partner_realtion[]" id="profile_partner_realtion_<?php echo $kp; ?>" class="custom-select">
						...
						<!-- Marital Status Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_marital_status[]" id="profile_partner_marital_status_<?php echo $kp; ?>" class="custom-select">
									...
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_parnter_blood_group[]" id="profile_parnter_blood_group_<?php echo $kp; ?>" class="custom-select">
												<option value="">Blood Group</option>
												<?php foreach($bloodgroupsslist as $bgroups){
													$selectedd = "";													
						...
						<!-- Qualification & Profession Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_qualification[]" id="profile_partner_qualification_<?php echo $kp; ?>" class="custom-select">
												<option value="">Qualification</option>
												<?php foreach($qualificationslist as $qualifications){ 
													$zeroSelected = "";
									...
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_profession[]" id="profile_partner_profession_<?php echo $kp; ?>" class="custom-select">
						...
						<!-- Date of Birth Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="text-weight-medium">Date of Birth</label>
									<div class="d-flex justify-content-between">
										<select required name="profile_partner_dob_date[]" id="profile_partner_dob_date_<?php echo $kp; ?>" class="custom-select alt-1">
											<?php for($d=1;$d<=31;$d++){ 
												$dateDate = "";
												$ds = "";
												if($d==$ddddate){
										...
										<select required name="profile_partner_dob_month[]" id="profile_partner_dob_month_1" class="custom-select alt-1 mx-2">
										<?php 
											$formattedMonthArray = array(
												"01" => "Jan", "02" => "Feb", "03" => "Mar", "04" => "Apr",
												"05" => "May", "06" => "Jun", "07" => "Jul", "08" => "Aug",
										...
										<select required name="profile_partner_dob_year[]" id="profile_partner_dob_year_<?php echo $kp; ?>" class="custom-select alt-1">
											<?php $yearv = date('Y'); $laste20years = $yearv; 
											for($i=1980;$i<=$laste20years;$i++) { 
												$yys = "";
												if($i==$dddyear){
				...
				<td class="" style="border:none">
				   <div class="">						
						...
						<!-- Qualification & Profession Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<select name="profile_partner_realtion[]" id="profile_partner_realtion_1" class="custom-select">
						...
						<!-- Marital Status Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_marital_status[]" id="profile_partner_marital_status_1" class="custom-select">
									...
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_parnter_blood_group[]" id="profile_parnter_blood_group_1" class="custom-select">
												<option value="">Blood Group</option>
												<?php foreach($bloodgroupsslist as $bgroups){ ?>
						...
						<!-- Qualification & Profession Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_qualification[]" id="profile_partner_qualification_1" class="custom-select">
												<option value="">Qualification</option>
												<?php foreach($qualificationslist as $qualifications){ ?>
									...
									<div class="col-md-6">
										<div class="form-group">
											<select name="profile_partner_profession[]" id="profile_partner_profession_1" class="custom-select">
												<option value="">Profession</option>
												<?php foreach($professionslist as $professions){ ?>
						...
						<!-- Date of Birth Starts -->
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="text-weight-medium">Date of Birth</label>
									<div class="d-flex justify-content-between">
										<select required name="profile_partner_dob_date[]" id="profile_partner_dob_date_1" class="custom-select alt-1">
											<?php for($d=1;$d<=31;$d++){ 
												$dateDate = "";
												$datepadding = str_pad($d, 2, "0", STR_PAD_LEFT);
											?>
										...
										<select required name="profile_partner_dob_year[]" id="profile_partner_dob_year_1" class="custom-select alt-1">
											<?php $yearv = date('Y'); $laste20years = $yearv; 
											for($i=1980;$i<=$laste20years;$i++) { 
											?>
			...
			<!-- Declaration Starts -->
				...
				<!-- Terms Starts -->
					<div class="custom-control custom-checkbox">
						<input class="custom-control-input" type="checkbox" value="" id="invalidCheck" name="invalidCheck" required>
						<label class="custom-control-label text-big-2 lh-1" for="invalidCheck">
							I declare that the particulars furnished above are true to the best of my knowledge and agree that our familiy responsibility to make enquiry about the other party before the alliance is settled.
						</label>
						<span id="error_invalidCheck" style="color:red;"></span>
					<!-- Submit Button Starts -->
						<p class="mt-3"><button type="button" class="btn btn-main btn-style-2 text-weight-semi-bold text-big-2 animation rounded-2" onClick="return formValidate();">Submit Form</button></p>
					<!-- Submit Button Ends -->
					</div>
				<!-- Terms Ends -->
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$("#addrow").on("click", function () {
				...
				$.ajax({
					type		:	'POST',
					url			:  	base_url+'User/getMemberAddittionalInfo?sRch='+time,
					dataType	: 	"json",
