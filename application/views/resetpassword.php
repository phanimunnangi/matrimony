<!-- Page Banner Starts -->
        ...
        <!-- Banner Image Ends -->
			 <div class="container px-md-0 text-white text-center d-none d-md-block" style="bottom:50%;">
                <h2 class="text-weight-semi-bold">Reset Password</h2>
            </div>
		</div>
	<!-- Page Banner Ends -->
	<!-- Main Container Starts -->
        ...
        <!-- Nested Row Starts -->
            ...
            <!-- Sidearea Ends -->
            <!-- Mainarea Starts -->
				<?php if($panlinkexpried=='linkexpired'){ ?>
					<div class="col-lg-9 col-md-8 col-sm-12 py-4 py-md-0">
						<div class="row ">
							...
							<div class="col-md-12 text-center" style="margin-top:5%;">									
								<p class=""><b>Link expired</b></p>
								<div class="box-footer">
									<a href="<?php echo base_url();?>" class="btn btn-default"><button type="button" class="btn btn-main btn-style-2 animation">Cancel</button></a>	
								</div>
							</div>
						</div>
					</div>					
				<?php }else{ ?>
					<div class="col-lg-9 col-md-8 col-sm-12 py-4 py-md-0">
						<form id="changepwdform" name="changepwdform" method="POST">
							<input type="hidden" id="userid" name="userid" value="<?php echo $user_registeredid; ?>">
							 <input type="hidden" id="oldpassword" name="oldpassword" value="<?php echo $user_encrpted_password; ?>">
							 <input type="hidden" id="homepage" name="homepage" value="adminreset">
							 <input type="hidden" id="homepagee" name="homepagee" value="resefreset">
